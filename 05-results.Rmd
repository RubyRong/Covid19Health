...
Here we could see the condition of PPE supply of nursing houses across the U.S. The data provides six dates when it did the survey about the PPE supply. On 2020-05-24, we can notice that a great ratio of nursing houses of the U.S had the shortages for all four types of PPE. On 2020-07-19, the shortage of hand sanitizers was firstly solved and after that, the ratio of nursing houses which have shortage of hand sanitizers was always at a low level. However, the shortages of the other three PPE were serious unlike the hand sanitizer. The shortage of surgerical masks and eye protections lasted till 2020-12-20, when the ratio had decreased to a relatively low value. It means that the shortage nearly lasted half a year, which explained the uncontrolled increase of resident cases happened in the second half of 2021. The most serious shortage was the shortage of N95 masks. The shortage ratio of the first four surveies was really high. The shortage ratio only dropped to a satisfying level on 2021-02-28, but still higher than the ratio of the other three types of PPE. 
